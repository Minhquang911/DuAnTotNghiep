            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.books.index')); ?>" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Quản lý sách</p>
                            </a>
                        </li>
...
<?php /**PATH D:\xamp\htdocs\DuAnTotNghiep\websiteBanSach\resources\views/admin/layout/blocks/aside.blade.php ENDPATH**/ ?>