                ...
                <div class="row mb-4">
                    <div class="col-md-3 text-center">
                        @if ($product->cover_image_url)
                            <img src="{{ $product->cover_image_url }}" class="product-cover mb-2" width="200" alt="Ảnh bìa">
                        @else
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">{{ $product->published_at ? $product->published_at->format('d/m/Y') : '-' }}</div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8 product-badges">
                                ...
                                @endif
                                @if(!$product->is_hot && !$product->is_new && !$product->is_best_seller && !$product->is_recommended && !$product->is_featured && !$product->is_promotion)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($variant->promotion_price)
                                            <span class="text-danger">{{ number_format($variant->promotion_price) }}₫</span>
                                        @else
                                            <span class="text-muted">-</span>
                                        @endif
                                    </td>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <select class="form-select form-select-sm" style="width: auto" id="perPageSelect">
                                        <option value="5" {{ request('per_page', 5) == 5 ? 'selected' : '' }}>5 bình luận</option>
                                        <option value="10" {{ request('per_page', 5) == 10 ? 'selected' : '' }}>10 bình luận</option>
                                        <option value="20" {{ request('per_page', 5) == 20 ? 'selected' : '' }}>20 bình luận</option>
                                        <option value="50" {{ request('per_page', 5) == 50 ? 'selected' : '' }}>50 bình luận</option>
                                    </select>
                                </div>
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <select class="form-select form-select-sm" style="width: auto" id="sortSelect">
                                        ...
                                        <option value="oldest" {{ request('sort', 'latest') == 'oldest' ? 'selected' : '' }}>Cũ nhất</option>
                                        <option value="most_replies" {{ request('sort', 'latest') == 'most_replies' ? 'selected' : '' }}>Nhiều trả lời nhất</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <h6 class="mb-1">
                                                        ...
                                                        @if($parentComment->replies_count > 0)
                                                            <span class="badge bg-info ms-2">
                                                                <i class="fas fa-reply me-1"></i>{{ $parentComment->replies_count }}
                                                            </span>
                                                        @endif
                                                    </h6>
                                            ...
                                            @if($parentComment->replies->count() > 0)
                                                <button class="btn btn-link btn-sm p-0 text-decoration-none toggle-replies collapsed" 
                                                        data-bs-toggle="collapse" 
                                                        data-bs-target="#replies-{{ $parentComment->id }}">
                                                    <i class="fas fa-chevron-down me-1"></i>
                                                    <span class="show-text">Hiển thị {{ $parentComment->replies->count() }} trả lời</span>
                                    ...
                                    @if($parentComment->replies->count() > 0)
                                        <div class="replies ms-5 mt-3 collapse" id="replies-{{ $parentComment->id }}">
                                            @foreach($parentComment->replies as $reply)
                                                <div class="reply-item mb-3 {{ !$loop->last ? 'border-bottom pb-3' : '' }}">
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0">
                            ...
                            @if($parentComments->hasPages())
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mt-4 gap-3">
                                    <div class="text-muted small">
                                        ...
                                        Hiển thị {{ $parentComments->firstItem() ?? 0 }} - {{ $parentComments->lastItem() ?? 0 }} 
