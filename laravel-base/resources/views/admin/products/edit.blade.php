                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('publisher_id') is-invalid @enderror"
                                            ...
                                            @foreach($publishers as $publisher)
                                                <option value="{{ $publisher->id }}" {{ old('publisher_id', $product->publisher_id) == $publisher->id ? 'selected' : '' }}>{{ $publisher->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('publisher_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('published_at') is-invalid @enderror"
                                            id="published_at" name="published_at" value="{{ old('published_at', $product->published_at ? $product->published_at->format('Y-m-d') : '') }}">
                                        @error('published_at')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" class="form-control @error('length_cm') is-invalid @enderror"
                                                    id="length_cm" name="length_cm" value="{{ old('length_cm', $product->length_cm) }}" placeholder="VD: 20.5">
                                                @error('length_cm')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" class="form-control @error('width_cm') is-invalid @enderror"
                                                    id="width_cm" name="width_cm" value="{{ old('width_cm', $product->width_cm) }}" placeholder="VD: 14.5">
                                                @error('width_cm')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" min="0" class="form-control @error('weight_g') is-invalid @enderror"
                                                    id="weight_g" name="weight_g" value="{{ old('weight_g', $product->weight_g) }}" placeholder="VD: 350">
                                                @error('weight_g')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" min="1" class="form-control @error('page_count') is-invalid @enderror"
                                                    id="page_count" name="page_count" value="{{ old('page_count', $product->page_count) }}" placeholder="VD: 320">
                                                @error('page_count')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="mt-2">
                                            @if($product->cover_image_url)
                                                <img id="preview" src="{{ $product->cover_image_url }}" alt="Preview" class="preview-image">
                                            @else
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                            id="description" name="description" rows="4" placeholder="Nhập mô tả sách">{{ old('description', $product->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="is_best_seller" name="is_best_seller" value="1" {{ old('is_best_seller', $product->is_best_seller) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_best_seller">Bán chạy nhất</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="is_recommended" name="is_recommended" value="1" {{ old('is_recommended', $product->is_recommended) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="is_promotion" name="is_promotion" value="1" {{ old('is_promotion', $product->is_promotion) ? 'checked' : '' }}>
                                        ...
                                        @foreach($product->variants as $i => $variant)
                                            <div class="variant-card" id="variant-{{ $i }}">
                                                <div class="variant-header">
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm remove-variant" data-variant="{{ $i }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select class="form-select" name="variants[{{ $i }}][format_id]" required>
                                                                <option value="">Chọn định dạng</option>
                                                                @foreach($formats as $format)
                                                                    <option value="{{ $format->id }}" {{ $variant->format_id == $format->id ? 'selected' : '' }}>{{ $format->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select class="form-select" name="variants[{{ $i }}][language_id]" required>
                                                                <option value="">Chọn ngôn ngữ</option>
                                                                @foreach($languages as $language)
                                                                    <option value="{{ $language->id }}" {{ $variant->language_id == $language->id ? 'selected' : '' }}>{{ $language->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="variants[{{ $i }}][sku]" value="{{ $variant->sku }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                            <label>Giá <span class="text-danger">*</span></label>
                                                            <input type="number" class="form-control" name="variants[{{ $i }}][price]" value="{{ $variant->price }}" min="0" step="1000" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                            <label>Giá khuyến mãi</label>
                                                            <input type="number" class="form-control" name="variants[{{ $i }}][promotion_price]" value="{{ $variant->promotion_price }}" min="0" step="1000">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                            <label>Số lượng <span class="text-danger">*</span></label>
                                                            <input type="number" class="form-control" name="variants[{{ $i }}][stock]" value="{{ $variant->stock }}" min="0" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="form-check form-switch mt-2">
                                                                <input class="form-check-input" type="checkbox" name="variants[{{ $i }}][is_active]" value="1" {{ $variant->is_active ? 'checked' : '' }}>
