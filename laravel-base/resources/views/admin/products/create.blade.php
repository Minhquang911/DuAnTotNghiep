                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" class="form-control @error('length_cm') is-invalid @enderror" id="length_cm" name="length_cm" value="{{ old('length_cm') }}" placeholder="VD: 20.5">
                                                @error('length_cm')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" class="form-control @error('width_cm') is-invalid @enderror" id="width_cm" name="width_cm" value="{{ old('width_cm') }}" placeholder="VD: 14.5">
                                                @error('width_cm')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" min="0" class="form-control @error('weight_g') is-invalid @enderror" id="weight_g" name="weight_g" value="{{ old('weight_g') }}" placeholder="VD: 350">
                                                @error('weight_g')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" min="1" class="form-control @error('page_count') is-invalid @enderror" id="page_count" name="page_count" value="{{ old('page_count') }}" placeholder="VD: 320">
                                                @error('page_count')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-success btn-sm me-2" data-bs-toggle="modal" data-bs-target="#quickGenerateModal">
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <select class="form-select" id="quick-formats" multiple>
                                                                    @foreach($formats as $format)
                                                                        <option value="{{ $format->id }}" data-code="{{ $format->code }}">{{ $format->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="number" class="form-control" id="quick-base-price" min="0" step="1000" placeholder="Nhập giá cơ bản">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-3">
                                                                <label>Giá khuyến mãi</label>
                                                                <input type="number" class="form-control" id="quick-promotion-price" min="0" step="1000" placeholder="Nhập giá khuyến mãi">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-3">
                                                                <label>Số lượng mặc định <span class="text-danger">*</span></label>
                                                                <input type="number" class="form-control" id="quick-default-stock" min="0" value="0" placeholder="Nhập số lượng">
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="alert alert-info">
                                                        <h6 class="alert-heading">Số phiên bản sẽ được tạo: <span id="variant-count">0</span></h6>
                                                        <p class="mb-0">Số lượng phiên bản = Số định dạng × Số ngôn ngữ</p>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary" id="generate-variants">Tạo phiên bản</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function updatePreview() {
            ...
            formats.forEach(format => {
                languages.forEach(language => {
                    const sku = `${isbn}-${format.id}-${language.element.dataset.code}`.toUpperCase();
                    previewHtml += `
                        <tr>
                            <td>${format.text}</td>
                            <td>${language.text}</td>
        ...
        $('#quick-formats, #quick-languages, #quick-base-price, #quick-promotion-price, #quick-default-stock, #isbn').on('change keyup', updatePreview);
        ...
        $(document).on('change', 'select[name^="variants"][name$="[format_id]"], select[name^="variants"][name$="[language_id]"]', function() {
