            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-gradient-primary">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title text-white fw-bold">
                                <i class="fas fa-plus me-2"></i>Thêm định dạng sách mới
                            </h3>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.formats.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            ...
                                            placeholder="Nhập tên định dạng sách (VD: Bìa mềm, Bìa cứng, Ebook)">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-text">Slug được sử dụng trong URL, tự động tạo từ tên định dạng</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i> Lưu định dạng
                                </button>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            // Tự động tạo slug từ tên định dạng
